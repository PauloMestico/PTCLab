                ...
                <div class="row g-3">
                    <div class="col-12">
                        ...
                        <div class="form--select">
                            <select class="form-select" name="method_code" required {{ $leftRefer>0 ? "disabled"  : ""}}>
                    ...
                    <div class="col-12">
                        ...
                        <div class="input-group input--group">
                            <input type="number" step="any" name="amount" value="{{ old('amount') }}" class="form-control form--control" required {{ $leftRefer>0 ? "disabled"  : ""}}>
        ...
        <div class="col-md-5 col-xxl-4">
            <div class="card custom--card">
                ...
                <div class="card-body">
                    ...
                    <button type="submit" class="btn btn--lg btn--base w-100 mt-3" {{ $leftRefer>0 ? "disabled"  : ""}}>@lang('Submit')</button>
                </div>
            </div>
        </div>
    </div>
